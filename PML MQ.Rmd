...
Please download traing and test datasets from the following links and save them in your working directory if you wish to reproduce my results.
...
In addition to the datasets, you may also need to install certain packages required to run the code.
...
Data cleaning is done in three steps given below:

1. Cleaning Near zero variance variables
